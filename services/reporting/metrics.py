...
def calculate(data: dict[str,Any], as_of: str='2026-09-07')->dict[str,Any]:
    ...
    draft=f"本周固定模拟数据新增 {metrics['risk_total']} 条候选，其中高风险 {metrics['high_risk']} 条、已确认 {metrics['confirmed']} 条。当前逾期行动 {overdue} 条。误报率为 {metrics['false_positive_rate']:.1%}，只反映本周模拟样本。"
